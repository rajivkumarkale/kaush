...
// Ensure all types are of the correct size on the machine
...
#define KKPLATFORM_ANDROID 1
#endif
#elif defined(__unix__)
#define KPLAKPLATFORM_UNIX 1
#elif defined(_POSIX_VERSION)
#define KPLATFORM_POSIX 1
#elif __APPLE__
// Apple OS
#define KPLKPLATFORM_APPLE 1
#include <TargetConditionals.h>
#if TARGET_IPHONE_SIMULATOR
#define KPLKPLATFORM_IOS 1
#define KPLKPLATFORM_IOS_SIMULATOR 1
